...
public class EmployeeController {
	 ...
	 * 
	 * @GetMapping("/findAll") public List<Student> findAll() { return
	 * studentRepo.findAll(); }
	 * 
	 * @GetMapping("/findById/{id}") public Student findAll(@PathVariable long id) {
	 * Optional<Student> student= studentRepo.findById(id); if(student.isPresent())
	 * { return student.get(); } else { return null; } }
	 * 
	 * @GetMapping("/getById") public Student findById(@RequestParam(name="id") long
	 * id) { Optional<Student> student= studentRepo.findById(id);
